...
import com.advnmpproj.adv160818008midterm.utility.buildRDB
...
class RecListViewModel(application:Application):AndroidViewModel(application), CoroutineScope {
...
//    }
    ...
    fun loadData(){
        launch {
            val db = buildRDB(getApplication())
            recipesLD.value = db.recipeDao().selectAllRec()
        }
    }
